...
bool rpc_generic_prepare_invoke( rpc_backup_t*, bool );
rpc_backup_t* rpc_generic_raise( task_thread_t*, task_process_t*, size_t, void*, size_t, task_thread_t*, bool, size_t, bool, bool, bool, bool );
